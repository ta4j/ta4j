...
public class FullyMemorizedSlicerTest {
	...
	public void testApllyForSeries(){
		...
		assertEquals(0, newSlicer.getSlice(3).getBegin());
	...
	public void testSplitByYearOneDatePerYear() {
		...
		assertEquals(0, split.getSlice(3).getBegin());
		assertEquals(3, split.getSlice(3).getEnd());
		assertEquals(0, split.getSlice(4).getBegin());
	...
	public void testSplitByYearForcingJuly() {
		...
		assertEquals(3, split.getSlice(2).getBegin());
