...
public class AccumulationDistributionTest {
	...
	public void testAccumulationDistribution()
	{
		...
		ticks.add(new DefaultTick(null, 0d, 10d, 12d, 8d, 0d, 0d, 200d,0));//2-2 * 200 / 4
		ticks.add(new DefaultTick(null, 0d, 8d, 10d, 7d, 0d, 0d, 100d,0));//1-2 *100 / 3
		ticks.add(new DefaultTick(null, 0d, 9d, 15d, 6d, 0d, 0d, 300d,0));//3-6 *300 /9
