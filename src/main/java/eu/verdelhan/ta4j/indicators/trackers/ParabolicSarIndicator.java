...
public class ParabolicSarIndicator extends CachedIndicator<BigDecimal> {
	...
	private final LowestValueIndicator<BigDecimal> lowestValueIndicator;

	private final HighestValueIndicator<BigDecimal> highestValueIndicator;
	...
	public ParabolicSarIndicator(TimeSeries series, int timeFrame) {
		...
		this.series = series;
		this.lowestValueIndicator = new LowestValueIndicator<BigDecimal>(new MinPriceIndicator(series), timeFrame);
		this.highestValueIndicator = new HighestValueIndicator<BigDecimal>(new MaxPriceIndicator(series), timeFrame);
