 ...
 * period return spans from the series start to the first period end. Trade
 * sampling uses each included position interval directly. Pre-entry intervals
 * are handled by {@link CashReturnPolicy}:
