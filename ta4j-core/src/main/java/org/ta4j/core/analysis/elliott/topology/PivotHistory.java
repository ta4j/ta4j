 ...
 */
public final class PivotHistory {
     ...
     */
    public static PivotHistory of(final List<ConfirmedPivot> raw) {
     ...
     */
    public List<ConfirmedPivot> pivots() {
        return pivots;
    }
     ...
     */
    public List<ConfirmedPivot> asOf(final int barIndex) {
