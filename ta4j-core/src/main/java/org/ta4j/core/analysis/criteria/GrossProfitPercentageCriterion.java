...
/**
 * Gross profit criterion in percentage.
 *
 * The gross profit of the provided {@link Trade trade(s)} over the provided
 * {@link BarSeries series}.
 */
public class GrossProfitPercentageCriterion extends AbstractAnalysisCriterion {
    ...
    /**
     * Calculates the gross profit percentage of given trade
     *
    ...
    public Num calculate(BarSeries series, Trade trade) {
        if (trade.isClosed()) {
            ...
            Num profit = trade.getGrossProfit().dividedBy(entryPrice).multipliedBy(series.numOf(100));
