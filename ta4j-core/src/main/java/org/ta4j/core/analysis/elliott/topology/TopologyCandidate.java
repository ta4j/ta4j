 ...
 *                  types
 */
public record TopologyCandidate(TopologyGrammar grammar, WaveDirection direction, List<ConfirmedPivot> pivots) {
     ...
     */
    public Num legStartPrice(final int legIndex) {
     ...
     */
    public Num legEndPrice(final int legIndex) {
     ...
     */
    public Num legSize(final int legIndex) {
