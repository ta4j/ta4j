...
public final class TopologyAnalyzer {
    ...
    public TopologyAnalyzer(final int maxHistoryPivots) {
     ...
     */
    public TopologyAnalysis analyze(final TopologyGrammar grammar, final PivotHistory history, final int asOfIndex) {
     ...
     * @return explicit topology outcome
     */
    public TopologyAnalysis analyze(final TopologyGrammar grammar, final List<ConfirmedPivot> confirmed) {
