...
final class RuleAblation {
    ...
    static List<Mode> modes() {
        return modes(ClassicalRelationshipRules.classicalRelationships(), "classical-all");
    }
    ...
    static List<Mode> frozenModes(final List<RelationshipRule> suppliedRules) {
        ...
        return modes(frozenRules, "classical-all");
    }
    ...
    static List<Mode> modes(final List<RelationshipRule> suppliedRules) {
        return modes(suppliedRules, "all-rules");
    }

    private static List<Mode> modes(final List<RelationshipRule> suppliedRules, final String allRulesModeName) {
        ...
        modes.add(new Mode(allRulesModeName, rules));
