...
public class CorrelationCoefficientIndicator extends CachedIndicator<Num> {
    ...
    public CorrelationCoefficientIndicator(Indicator<Num> indicator1, Indicator<Num> indicator2, int barCount,
        ...
        this.variance1 = this.sampleType.isSample() ? VarianceIndicator.ofSample(indicator1, barCount)
                : VarianceIndicator.ofPopulation(indicator1, barCount);
        this.variance2 = this.sampleType.isSample() ? VarianceIndicator.ofSample(indicator2, barCount)
                : VarianceIndicator.ofPopulation(indicator2, barCount);
