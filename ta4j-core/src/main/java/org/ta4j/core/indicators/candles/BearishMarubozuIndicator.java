 ...
 *
 * <p>
 * A candle at index {@code i} is a bearish Marubozu when its body is strictly
 ...
 * direction context. A bearish Marubozu is traditionally interpreted as a sign
 * of strong downward momentum, but whether it predicts continuation depends on
...
public class BearishMarubozuIndicator extends AbstractMarubozuIndicator {
    ...
    /**
     * Creates a bearish Marubozu indicator with the default thresholds: a 5-candle
    ...
    /**
     * Creates a bearish Marubozu indicator with a custom average period.
     *
     * @param series        the bar series
