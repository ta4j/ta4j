 ...
 * {@link org.ta4j.core.indicators.CorrentropyKalmanWeightIndicator} exposes
 * the per-measurement robustness weight in [0, 1]. The correntropy kernel
 * bandwidth is dimensionless because the fixed-point update whitens its
 * errors, and Q/R noise variances are in source units squared.
 *
 * @see <a href=
