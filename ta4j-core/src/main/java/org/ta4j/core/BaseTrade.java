...
public class BaseTrade implements Trade {
     ...
     * @since 0.22.4
     */
    public static BaseTrade buyAt(int index, BarSeries series) {
        return new BaseTrade(index, series, Trade.TradeType.BUY);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade buyAt(int index, Num price, Num amount, CostModel transactionCostModel) {
        return new BaseTrade(index, Trade.TradeType.BUY, price, amount, transactionCostModel);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade buyAt(int index, Num price, Num amount) {
        return new BaseTrade(index, Trade.TradeType.BUY, price, amount);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade buyAt(int index, BarSeries series, Num amount) {
        return new BaseTrade(index, series, Trade.TradeType.BUY, amount);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade buyAt(int index, BarSeries series, Num amount, CostModel transactionCostModel) {
        return new BaseTrade(index, series, Trade.TradeType.BUY, amount, transactionCostModel);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade sellAt(int index, BarSeries series) {
        return new BaseTrade(index, series, Trade.TradeType.SELL);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade sellAt(int index, Num price, Num amount) {
        return new BaseTrade(index, Trade.TradeType.SELL, price, amount);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade sellAt(int index, Num price, Num amount, CostModel transactionCostModel) {
        return new BaseTrade(index, Trade.TradeType.SELL, price, amount, transactionCostModel);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade sellAt(int index, BarSeries series, Num amount) {
        return new BaseTrade(index, series, Trade.TradeType.SELL, amount);
    }
     ...
     * @since 0.22.4
     */
    public static BaseTrade sellAt(int index, BarSeries series, Num amount, CostModel transactionCostModel) {
