...
public final class FuturesContract implements Serializable {
    ...
    private FuturesContract(Builder builder) {
        ...
        this.minimumQuantity = FuturesValidation.requirePositiveFiniteOrNull(
                normalizeToFactory(builder.minimumQuantity, this.contractSize), "minimumQuantity");
        ...
        this.maximumQuantity = FuturesValidation.requirePositiveFiniteOrNull(
                normalizeToFactory(validatedMaximumQuantity, this.contractSize), "maximumQuantity");
        this.minimumNotional = FuturesValidation.requirePositiveFiniteOrNull(
                normalizeToFactory(builder.minimumNotional, this.contractSize), "minimumNotional");
        ...
        this.maximumNotional = FuturesValidation.requirePositiveFiniteOrNull(
                normalizeToFactory(validatedMaximumNotional, this.contractSize), "maximumNotional");
    ...
    public Num marginRequirement(Num contracts, Num referencePrice, Num marginRate) {
        ...
        FuturesValidation.requireNonNegativeFinite(normalizedMarginRate, "marginRate");
        if (marginRate.isPositive() && normalizedMarginRate.isZero()) {
