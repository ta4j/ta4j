...
public class PlusDMIndicatorTest extends AbstractIndicatorTest<Indicator<Num>, Num> {
    ...
    public void zeroDirectionalMovement() {
        ...
        var yesterdayBar = series.barBuilder().openPrice(2).closePrice(10).highPrice(10).lowPrice(2).build();
        var todayBar = series.barBuilder().openPrice(6).closePrice(6).highPrice(6).lowPrice(6).build();
