...
public class DownTrendIndicatorTest extends AbstractIndicatorTest<Indicator<Boolean>, Boolean> {

    public DownTrendIndicatorTest(NumFactory numFactory) {
        super(numFactory);
    }
    ...
    public void returnsFalseBeforeUnstableWindow() {
        ...
        DownTrendIndicator indicator = new DownTrendIndicator(series, 5);
    ...
    public void unstableBarsTrackDependentIndicators() {
        ...
        DownTrendIndicator indicator = new DownTrendIndicator(series, barCount);
