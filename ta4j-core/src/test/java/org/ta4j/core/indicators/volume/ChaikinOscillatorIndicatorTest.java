...
public class ChaikinOscillatorIndicatorTest extends AbstractIndicatorTest<Indicator<Num>, Num> {
    ...
    public void getValue() {
        ...
        series.barBuilder()
                ...
                .volume(136135)
                .add();
        series.barBuilder().openPrice(13.490).closePrice(13.495).highPrice(13.495).lowPrice(13.310).volume(92090).add();
        series.barBuilder().openPrice(13.350).closePrice(13.490).highPrice(13.490).lowPrice(13.325).volume(80948).add();
        series.barBuilder().openPrice(13.415).closePrice(13.460).highPrice(13.460).lowPrice(13.290).volume(82983).add();
        series.barBuilder()
                .openPrice(13.320)
                .closePrice(13.320)
                .highPrice(13.320)
                ...
                .volume(126918)
                .add();
        series.barBuilder().openPrice(13.145).closePrice(13.225).highPrice(13.225).lowPrice(13.090).volume(68560).add();
        series.barBuilder().openPrice(13.150).closePrice(13.250).highPrice(13.250).lowPrice(13.110).volume(41178).add();
        series.barBuilder().openPrice(13.245).closePrice(13.250).highPrice(13.250).lowPrice(13.120).volume(63606).add();
