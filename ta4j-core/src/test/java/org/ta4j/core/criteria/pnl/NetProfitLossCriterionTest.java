...
public class NetProfitLossCriterionTest extends AbstractPnlCriterionTest {

    public NetProfitLossCriterionTest(NumFactory numFactory) {
        super(params -> new NetProfitLossCriterion(), numFactory);
    }
