...
public class ReturnsTest extends AbstractIndicatorTest<Indicator<Num>, Num> {
    ...
    @Test
    public void returnsIncludeMultipleOpenLotsFromLiveTradingRecord() {
        ...
        record.recordFill(0, new SimulatedTrade(0, Instant.EPOCH, series.getBar(0).getClosePrice(), numFactory.one(),
