...
public class ExpectancyCriterionTest extends AbstractCriterionTest {
    ...
    public void calculate() {
        ...
        // 50% win ratio -> 0.5 expectancy

        AnalysisCriterion expectancy = getCriterion();

        assertNumEquals(0.4499d, expectancy.calculate(series, tradingRecord));
    }
    ...
    public void calculateWithShortPositions() {
        ...
        assertNumEquals(1.5d, expectancy.calculate(series, tradingRecord));
    }
