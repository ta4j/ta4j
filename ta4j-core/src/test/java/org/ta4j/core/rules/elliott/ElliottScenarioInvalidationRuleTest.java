...
class ElliottScenarioInvalidationRuleTest {
    ...
    void invalidationRuleTriggersWhenPriceBreaksLevel() {
        ...
        Indicator<Num> close = ElliottScenarioRuleTestSupport.constantIndicator(series, numFactory.numOf(110));
    ...
    void invalidationRuleRemainsFalseWhenPriceHolds() {
        ...
        ElliottScenarioSet set = ElliottScenarioSet.of(List.of(scenario), series.getEndIndex());
        Indicator<ElliottScenarioSet> indicator = ElliottScenarioRuleTestSupport.fixedScenarioIndicator(series, set);
        Indicator<Num> close = ElliottScenarioRuleTestSupport.constantIndicator(series, numFactory.numOf(130));
