...
class ElliottScenarioStopViolationRuleTest {
    ...
    void stopViolationRuleDetectsBreach() {
        ...
        Indicator<Num> close = ElliottScenarioRuleTestSupport.constantIndicator(series, numFactory.numOf(120));
    ...
    void stopViolationRuleDetectsBearishBreach() {
        ...
        ElliottScenarioSet set = ElliottScenarioSet.of(List.of(scenario), series.getEndIndex());
        Indicator<ElliottScenarioSet> indicator = ElliottScenarioRuleTestSupport.fixedScenarioIndicator(series, set);
        Indicator<Num> close = ElliottScenarioRuleTestSupport.constantIndicator(series, numFactory.numOf(180));
