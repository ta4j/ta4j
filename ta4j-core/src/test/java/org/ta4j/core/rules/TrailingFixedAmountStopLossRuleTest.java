...
public class TrailingFixedAmountStopLossRuleTest extends AbstractIndicatorTest<Object, Object> {
    ...
    public TrailingFixedAmountStopLossRuleTest(NumFactory numFactory) {
        super(numFactory);
    }
    ...
    public void isSatisfiedForBuy() {
        ...
        tradingRecord.enter(5, numOf(128), numFactory.one());
    ...
    public void isSatisfiedForBuyForBarCount() {
        BaseTradingRecord tradingRecord = new BaseTradingRecord(TradeType.BUY);
        ClosePriceIndicator closePrice = new ClosePriceIndicator(new MockBarSeriesBuilder().withNumFactory(numFactory)
                .withData(100, 110, 120, 130, 120, 117.00, 117.00, 130, 116.00)
                .build());

        TrailingFixedAmountStopLossRule rule = new TrailingFixedAmountStopLossRule(closePrice, numOf(10), 3);
