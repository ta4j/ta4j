...
/**
 * Live Elliott Wave analysis for BTC-USD using Coinbase HTTP data.
 *
 * <p>
 ...
 * @since 0.22.3
 */
public class BTCUSDLiveElliottWaveAnalysis {

    private static final String DATA_SOURCE = "Coinbase";
    private static final String TICKER = "BTC-USD";
    private static final String BAR_DURATION = "PT1D";
    private static final long LOOKBACK_DAYS = 1825L;

    /**
     * Runs live BTC-USD Elliott Wave analysis against Coinbase daily bars.
     *
