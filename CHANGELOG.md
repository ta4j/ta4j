## Unreleased
- **Futures review round 65**: futures profit rejects nonrepresentable final products, and inverse gross returns value executed exit fills separately from residual marks.
