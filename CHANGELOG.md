...
- **Price-structure aggregators**: Added `RangeBarAggregator`, `VolumeBarAggregator`, and `RenkoBarAggregator` to build derived bar series from range thresholds, volume thresholds, and configurable Renko box/reversal settings.
