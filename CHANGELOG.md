...
- **Indicator reference fixtures**: Removed the `PublishedReferenceSeries` test helper class and inlined published-reference OHLC fixtures directly inside `VortexIndicatorTest` and `UltimateOscillatorIndicatorTest`.
