## Unreleased
- **Futures review round 58**: spot as-of profit and entry costs exclude deferred fills, modeled futures rates and quantity increments remain representable in their active numeric factories, open spot cost basis honors the as-of cutoff, and processed funding retries cannot alias another cash-flow type or later equal-time schedule entry.
