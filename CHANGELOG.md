...
- **ConcurrentBarSeries** Preserve bar builder factories for sub-series and restore serialization round-trips by making bar builder factories serializable and reinitializing locks after deserialization.
