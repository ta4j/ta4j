...
- **Portfolio return correlation matrices**: Added `PortfolioCorrelations` for rolling log-return correlation matrices over an `AlignedPortfolioSeries`, reusing ta4j statistics indicators while preserving the portfolio feature's strict common-end-time timeline.
