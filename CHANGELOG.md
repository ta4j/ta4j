## Unreleased
- **Futures review round 58**: spot as-of profit, cost basis, and invested intervals exclude deferred fills while preserving trade-level fees, modeled futures rates and quantity increments remain representable in their active numeric factories, fee totals remain representable in the fill factory, and processed funding retries cannot alias another cash-flow type or later equal-time schedule entry.
