...
- **CF-525 study evidence is now unambiguous**: H2 reports complete-topology bar occupancy rather than cycle counts, relationship-rule aggregates state their unique-topology scope, and competing grammars share the same signed-pivot eligibility.
