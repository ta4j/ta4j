...
- **Futures review round 15**: scheduled funding is computed and allocated per held slice, single-position futures imports preserve cash flows, contract numeric equality and hashes are factory independent, and complete off-grid futures remainder closes are not lost.
