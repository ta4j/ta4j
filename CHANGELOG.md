...
- **SpotBugs known-debt cleanup**: Cleared targeted baseline entries for realtime bar equality, serializable bar builder factories, walk-forward calibration map iteration, charting/cache path guards, and obsolete Elliott macro demo private bridges.
