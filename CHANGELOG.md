...
- **Release automation tokens**: Standardized on `GH_TA4J_REPO_TOKEN` for release scheduler dispatch, release workflow checkout/tag push, GitHub Release creation, and release PR creation, with a GITHUB_TOKEN fallback for GitHub Release publishing.
