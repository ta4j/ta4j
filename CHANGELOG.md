...
- **Candle pattern foundation: shared adaptive thresholds**: Every candle pattern now shares one consistent, causal, cached body/shadow sizing model; single-candle patterns no longer apply ADX trend gates, and multi-candle patterns no longer rely on hidden trend requirements.
...
>>>>>>> feature/candle-foundation-slice-4-two-candle
