...
- **Futures review round 66**: funding and margin products reject nonrepresentable final arithmetic, futures analysis rejects lossy P&L conversion, and projection-ledger reads are synchronized with trading-record writes.
