...
### Changed
- **Agent PR handoff guidance is more explicit**: ta4j PR overrides now clarify when changelog entries are required and tell agents to delete temporary `.agents/plans/` PRD/checklist files before final handoff unless explicitly retained.
