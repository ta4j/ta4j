...
- **MACD-V package organization**: Grouped MACD-V specific helpers and indicators under `org.ta4j.core.indicators.macd` to reduce top-level indicators package clutter, and added deprecated compatibility shims in `org.ta4j.core.indicators` so downstream projects continue compiling while migrating imports.
