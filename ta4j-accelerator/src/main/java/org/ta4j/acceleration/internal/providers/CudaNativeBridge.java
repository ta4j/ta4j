...
interface CudaNativeBridge {
    ...
    CudaEvaluationResult evaluate(CudaNativeRequest request);
}
...
record CudaNativeRequest(int fromInclusive, int decisionCount, int horizon, int iterationCount, int lookbackBarCount,
        long seed, int shockModel, int volatilityMode, double volatilityDecayFactor, double[] quantiles, int[] stable,
