...
| Multi-asset portfolios | [`StaticPortfolioBacktest`](ta4j-examples/src/main/java/ta4jexamples/portfolio/StaticPortfolioBacktest.java) runs an aligned target-weight portfolio with scheduled rebalances, transaction costs, and per-bar snapshots |
