...
for module in ta4j-parent ta4j-core ta4j-examples ta4j-cli ta4j-acceleration; do
...
echo "Maven Central metadata validation passed for ta4j-parent, ta4j-core, ta4j-examples, ta4j-cli, ta4j-acceleration."
